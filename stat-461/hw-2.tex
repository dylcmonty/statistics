...
\[
\begin{aligned}
D &= \{FFFF\}\cup\{VFFF,FVFF,FFVF,FFFV\}\\
...
\begin{aligned}
C\cup D
&= \{FFFF,VVVV\}\cup\{FFFF,VFFF,FVFF,FFVF,FFFV\}\\
...
\begin{aligned}
C\cap D
&= \{FFFF,VVVV\}\cap\{FFFF,VFFF,FVFF,FFVF,FFFV\}\\
&= \{FFFF\}.
\end{aligned}
\]
...
\begin{aligned}
B\cup C
&= \{VFFF,FVFF,FFVF,FFFV\}\cup\{FFFF,VVVV\}\\
...
\[
\begin{aligned}
P(M\mid \text{Sh}\cap \text{Pl})
&=\frac{P(M\cap \text{Sh}\cap \text{Pl})}{P(\text{Sh}\cap \text{Pl})}\\
...
\begin{aligned}
P(L)
&=P(L\mid D)P(D)+P(L\mid D^c)P(D^c)\\
...
\[
\begin{aligned}
0.96^2&=0.9216,\quad 0.96^3=0.884736,\\
0.96^4&=0.84934656,\quad 0.96^5=0.8153726976.
\end{aligned}
\]
so
\[
